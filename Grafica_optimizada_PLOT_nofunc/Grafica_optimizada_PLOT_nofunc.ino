...
int kp_a =15;   //6       4       2       1           5
float ki_a = 0.37;  //0.0005  0.05   0.005  0.0005    0.02
int kd_a = 14;     //5       3     1       0.5       0.5
float cv = 0.0;
  ...
  for(;;){
    ...
    ////asignación de estados para el AZIMUT ////
        ...
        else if(error_a > 0.0)  //POSITIVO
        {
          ...
          /*  Serial.print("pid antihorario de a");
            Serial.print(": ");
            Serial.println( pid_val_a);*/
           if (flag == true){  
              val = 1500 -  pid_val_a ;
        ...
        else if (error_a < 0) //negativo
        {
          ...
          if(abs(error_a) >180){
            pid_val_a = pid_a.val_pid();
         //   Serial.print("Error negativo--- horario \t");
           ...
           /*   Serial.print("val horario: ");
            ...
            pid_val_a = pid_a.val_pid();
         //   Serial.print("Error negativo MOV-- anti horario\t");
